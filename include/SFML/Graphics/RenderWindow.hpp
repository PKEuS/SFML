...
public:
    ...
    RenderWindow(VideoMode mode, const char* title, Uint32 style = Style::Default, const ContextSettings& settings = ContextSettings());
    RenderWindow(VideoMode mode, const wchar_t* title, Uint32 style = Style::Default, const ContextSettings& settings = ContextSettings());
    ...
    RenderWindow(VideoMode mode, const std::wstring& title, Uint32 style = Style::Default, const ContextSettings& settings = ContextSettings());
